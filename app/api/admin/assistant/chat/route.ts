...
function buildSystemPrompt(input: {
  ...
  return [
    ...
    "Supported action types are draft_client_reply, draft_service_create, draft_product_create, draft_menu_item_create, draft_promo_code_create, and draft_booking_summary.",
    "Every action payload must include a short summary field describing what approval will do.",
    "draft_client_reply payload requires conversationId as the raw UUID conversation id, body, and summary. If useful, you may include conversationTag for display only.",
    "Never use a display tag like CONV-XXXXXX as conversationId. conversationTag is display-only and cannot be used for database execution.",
    ...
    "draft_menu_item_create payload requires name or title, price, summary, and optional description and image_url.",
    "Only propose draft_menu_item_create for restaurant or food workspaces.",
